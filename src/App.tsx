                  ...
                  <section id="contact" className="get-in-touch-section">
                    <div className="get-in-touch-wrapper">
                      <div className="get-in-touch-header">
                        ...
                        <img
                          src="/getintouchheart.webp"
                          alt=""
                          className="get-in-touch-heart"
                          width={72}
                          height={72}
                          decoding="async"
                          draggable={false}
                      ...
                      <div className="get-in-touch-card">
                        ...
                        <div className="get-in-touch-overlay">
                          <p className="get-in-touch-text">
                            Have an idea, a question, or a moment you want to bring to life? Get in touch and
                            start a conversation—sometimes that&apos;s all it takes for something meaningful to grow.
                          </p>
