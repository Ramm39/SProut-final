...
type HeroSectionProps = {
  ...
  id?: string
  /** CTA button href (default: #experience) */
  ctaHref?: string
  /** CTA button label (default: START ADVENTURE) */
  ctaText?: string
  /** Video source (default: first hero video). Use a different one to differentiate pages. */
  videoSrc?: string
